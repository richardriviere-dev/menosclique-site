---
title: "Repasse médico: como calcular comissões em clínicas"
description: "Aprenda a calcular repasse médico e comissões em clínicas: modelos de rateio, impostos, descontos e boas práticas para pagar profissionais sem erros."
pubDate: 2026-08-29
category: "Gestão de clínicas"
author: "Equipe MenosClique"
cover: "/blog-covers/repasse-medico-clinicas.jpg"
---
...
<table>
<tr><th>Situação</th><th>Faixa comum de repasse ao profissional</th></tr>
<tr><td>Profissional traz os próprios pacientes e usa estrutura mínima</td><td>Maior (mais próximo do topo)</td></tr>
<tr><td>Clínica capta o paciente, agenda e faz todo o suporte</td><td>Menor (mais próximo da base)</td></tr>
<tr><td>Procedimentos com alto custo de material e equipamento</td><td>Menor, pois insumos pesam no cálculo</td></tr>
...
1. **Defina a base de cálculo.** O repasse incide sobre o valor bruto pago pelo paciente ou sobre o valor líquido (já descontadas taxas de cartão, taxa de convênio e materiais)? Deixe isso explícito no contrato.
2. **Some a produção do período.** Levante todos os atendimentos do profissional no mês, com valores efetivamente recebidos — nunca o que foi apenas faturado e ainda não pago.
3. **Abata custos diretos combinados.** Materiais específicos, taxas de maquininha e, quando acordado, parte dos custos de convênio.
4. **Aplique o percentual de repasse.** Multiplique a base ajustada pelo percentual do profissional.
5. **Desconte os tributos retidos na fonte.** Conforme a relação jurídica (autônomo, PJ ou cooperado), incidem retenções específicas.
6. **Gere o comprovante e pague.** Emita o relatório detalhado, anexe os documentos e efetue o pagamento na data combinada.
...
<table>
<tr><th>Etapa</th><th>Valor</th></tr>
<tr><td>Produção recebida no mês</td><td>R$ 40.000,00</td></tr>
<tr><td>(-) Taxas de cartão (média 3%)</td><td>- R$ 1.200,00</td></tr>
<tr><td>(-) Materiais específicos usados</td><td>- R$ 800,00</td></tr>
<tr><td>Base de cálculo ajustada</td><td>R$ 38.000,00</td></tr>
<tr><td>Repasse ao profissional (60%)</td><td>R$ 22.800,00</td></tr>
<tr><td>Fica com a clínica (40%)</td><td>R$ 15.200,00</td></tr>
</table>
...
1. Não deixar claro se a base é bruta ou líquida — a maior fonte de discussão.
2. Alterar o percentual sem renegociar formalmente.
3. Atrasar o pagamento sem aviso.
4. Repassar valores de convênio antes de recebê-los e sofrer com glosas depois.
5. Não fornecer relatório detalhado, exigindo que o profissional confie "no escuro".
6. Ignorar as retenções tributárias e criar passivo fiscal.
